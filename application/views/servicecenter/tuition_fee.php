<link rel="stylesheet" type="text/css" href="/assets/css/servicecenter/online_consultation.css"/>
    <div class="container">
        <div class="section">
            <div class="title_box">
                <h3>수강료조회</h3>
                <p>수강료조회를 위해서 관심있는 과정을 작성해 주십시오. <br />
                상세한 과정커리큘럼 및 수강료는 캠퍼스마다 상이할 수 있으므로, 정확한 정보는 꼭 상담을 받으시기 바랍니다.</p>
            </div>
            <div class="form_box">
                <form action="/servicecenter/tuition_fee" method="post" name="frm" id="frm">
								<input name="c_gubun" id="c_gubun" type="hidden" value="1"/>
								<input name="code" id="code" type="hidden" value="c"/>
                    <fieldset>
                        <legend>수강료조회</legend>
                        ...
                        <div class="campus_box">
                            ...
                            <div><input type="text" disabled value="<?=getCampusName($manger->m_cam); ?>" /></div>
                        </div>
                        <div class="name_box">
